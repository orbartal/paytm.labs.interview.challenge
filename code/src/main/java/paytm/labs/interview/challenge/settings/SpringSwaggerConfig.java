package paytm.labs.interview.challenge.settings;
...
public class SpringSwaggerConfig {
	...
	protected ApiInfo getApiInfo() {
		...
		api.description("Example project that generate a Swagger ui client and Swagger json description of Spring boot Rest api. And then export this json as asciidoc, pdf and html files.");
		api.contact(contact);
		api.version("1.0.0");
		api.license("GNU");
